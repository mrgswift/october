...
class DashManager
{
    use \Backend\Classes\DashManager\HasDataSources;
    use \Backend\Classes\DashManager\HasVueReportWidgets;
    ...
    public function listAllReportWidgetGroups()
    {
        ...
        foreach ($this->widgetManager->listReportWidgets() as $className => $widgetInfo) {
            ...
            $isVueReport = is_subclass_of($className, \Backend\Classes\VueReportWidgetBase::class);
            if ($isVueReport) {
