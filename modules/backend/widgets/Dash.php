...
use Backend\Models\Dashboard as DashboardModel;
use SystemException;
...
{
    use \Backend\Widgets\Dash\HasWidgetData;
    use \Backend\Widgets\Dash\HasPropertyOptions;
    use \Backend\Widgets\Dash\ReportProcessor;
    use \Backend\Widgets\Dash\HasReportWidgets;
    ...
    public function init()
    {
        ...
        $this->controller->registerVueComponent(\Backend\VueComponents\Dashboard::class);
    ...
    {
        $this->addJs('js/DashStore.js');
        $this->addJs('js/Dash.js');
    ...
    protected function defineDashReports()
    {
         ...
         * Example usage:
         *
         *     Event::listen('backend.dash.extendReportsBefore', function ((\Backend\Widgets\Dash) $widget) {
         ...
         * Or
         *
         *     $dashWidget->bindEvent('dash.extendReportsBefore', function () use ((\Backend\Widgets\Dash $dashWidget)) {
         *         // You should always check to see if you're extending correct model/controller
         *         if (!$widget->model instanceof \Foo\Example\Models\Bar) {
         *             return;
         *         }
         ...
         * Example usage:
         *
         *     Event::listen('backend.dash.extendReports', function ((\Backend\Widgets\Dash) $widget) {
         ...
         * Or
         *
         *     $dashWidget->bindEvent('dash.extendReports', function () use ((\Backend\Widgets\Dash $dashWidget)) {
         *         // Only for the User controller
         *         if (!$widget->getController() instanceof \RainLab\User\Controllers\Users) {
         *             return;
         *         }
