<?php namespace Backend\Widgets\Dash;
...
trait HasReportWidgets
{
    ...
    protected function isReportWidget(string $reportType): bool
    {
        ...
        if (
            is_subclass_of($widgetClass, \Backend\Classes\ReportWidgetBase::class) ||
            is_subclass_of($widgetClass, \Backend\Classes\VueReportWidgetBase::class)
        ) {
            return true;
        }
