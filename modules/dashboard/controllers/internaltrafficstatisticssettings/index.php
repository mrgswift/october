    ...
    <div class="layout-row">
        <div class="form-group hint-field span-full">
            <div class="callout fade show callout-info no-subheader ">
                <div class="header">
                    <h3><?= e(trans('dashboard::lang.internal_traffic_statistics.hint')) ?></h3>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <p>
                <?php if ($featureEnabled): ?>
                    <?= e(trans('dashboard::lang.internal_traffic_statistics.enabled')) ?>
                <?php else: ?>
                    <?= e(trans('dashboard::lang.internal_traffic_statistics.disabled')) ?>
                <?php endif ?>
            </p>
        </div>
        ...
        <?php if ($featureEnabled): ?>
            <table class="table">
                <tr>
                    <td><?= e(trans('dashboard::lang.internal_traffic_statistics.timezone')) ?></td>
                    <td><?= e($timezone) ?></td>
                </tr>
                <tr>
                    <td><?= e(trans('dashboard::lang.internal_traffic_statistics.retention')) ?></td>
                    <td><?= e($retention) ?></td>
                </tr>
            </table>
        <?php endif ?>
