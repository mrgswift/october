...
/**
 * Backend_Widgets_Dash_DashStore
 */
class Backend_Widgets_Dash_DashStore
{
    state = {};

    constructor(delegate) {
        this.delegate = delegate;
        this.dashHelpers = new Backend_Dashboard_Helpers;
        this.dataSource = new Backend_Dashboard_DataSource(this);
