...
/**
 * Backend_Widgets_Dash
 */
class Backend_Widgets_Dash extends oc.ControlBase
{
    connect() {
    ...
    createStore() {
        ...
        const store = new Backend_Widgets_Dash_DashStore(this);
...
// Register the hot control
oc.registerControl('dashwidget', Backend_Widgets_Dash);
